...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IBMBlockCSIHostDefinerSpec) DeepCopyInto(out *IBMBlockCSIHostDefinerSpec) {
	*out = *in
	if in.Affinity != nil {
		in, out := &in.Affinity, &out.Affinity
		*out = new(corev1.Affinity)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IBMBlockCSIHostDefinerSpec.
func (in *IBMBlockCSIHostDefinerSpec) DeepCopy() *IBMBlockCSIHostDefinerSpec {
	if in == nil {
		return nil
	}
	out := new(IBMBlockCSIHostDefinerSpec)
	in.DeepCopyInto(out)
	return out
}
