...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IBMBlockCSILicense) DeepCopyInto(out *IBMBlockCSILicense) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IBMBlockCSILicense.
func (in *IBMBlockCSILicense) DeepCopy() *IBMBlockCSILicense {
	if in == nil {
		return nil
	}
	out := new(IBMBlockCSILicense)
	in.DeepCopyInto(out)
	return out
}
