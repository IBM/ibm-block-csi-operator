...
type csiControllerSyncer struct {
	driver *controller_instances.IBMBlockCSI
	obj    runtime.Object
}

// NewCSIControllerSyncer returns a syncer for CSI controller
func NewCSIControllerSyncer(c client.Client, scheme *runtime.Scheme, driver *controller_instances.IBMBlockCSI) syncer.Interface {
...
func getSidecarByName(driver *controller_instances.IBMBlockCSI, name string) *csiv1.CSISidecar {
