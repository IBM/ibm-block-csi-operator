...
import (
	...
	"github.com/IBM/ibm-block-csi-operator/controllers/internal/controller_instances"
...
type reconciler func(instance *controller_instances.IBMBlockCSI) error
...
func (r *IBMBlockCSIReconciler) Reconcile(ctx context.Context, req ctrl.Request) (reconcile.Result, error) {
	...
	instance := controller_instances.New(&csiv1.IBMBlockCSI{}, r.ServerVersion)
...
func (r *IBMBlockCSIReconciler) updateStatus(instance *controller_instances.IBMBlockCSI, originalStatus csiv1.IBMBlockCSIStatus) error {
...
func (r *IBMBlockCSIReconciler) restartControllerPod(logger logr.Logger, instance *controller_instances.IBMBlockCSI) error {
	controllerPod := &corev1.Pod{}
	controllerStatefulset, err := r.getControllerStatefulSet(instance)
	if err != nil {
		return err
...
func (r *IBMBlockCSIReconciler) reconcileCSIDriver(instance *controller_instances.IBMBlockCSI) error {
...
func (r *IBMBlockCSIReconciler) reconcileServiceAccount(instance *controller_instances.IBMBlockCSI) error {
...
func (r *IBMBlockCSIReconciler) getControllerStatefulSet(instance *controller_instances.IBMBlockCSI) (*appsv1.StatefulSet, error) {
...
func (r *IBMBlockCSIReconciler) getNodeDaemonSet(instance *controller_instances.IBMBlockCSI) (*appsv1.DaemonSet, error) {
...
func (r *IBMBlockCSIReconciler) reconcileClusterRole(instance *controller_instances.IBMBlockCSI) error {
...
func (r *IBMBlockCSIReconciler) deleteClusterRolesAndBindings(instance *controller_instances.IBMBlockCSI) error {
...
func (r *IBMBlockCSIReconciler) deleteClusterRoles(instance *controller_instances.IBMBlockCSI) error {
...
func (r *IBMBlockCSIReconciler) getClusterRoles(instance *controller_instances.IBMBlockCSI) []*rbacv1.ClusterRole {
...
func (r *IBMBlockCSIReconciler) reconcileClusterRoleBinding(instance *controller_instances.IBMBlockCSI) error {
...
func (r *IBMBlockCSIReconciler) deleteClusterRoleBindings(instance *controller_instances.IBMBlockCSI) error {
...
func (r *IBMBlockCSIReconciler) getClusterRoleBindings(instance *controller_instances.IBMBlockCSI) []*rbacv1.ClusterRoleBinding {
...
func (r *IBMBlockCSIReconciler) deleteCSIDriver(instance *controller_instances.IBMBlockCSI) error {
