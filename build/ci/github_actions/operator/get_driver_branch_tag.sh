...
is_controller_docker_image_has_tag=$(is_private_branch_component_image_exists controller)
is_node_docker_image_has_tag=$(is_private_branch_component_image_exists node)
