...
func (in *BlockCSIComponent) DeepCopyInto(out *BlockCSIComponent) {
	*out = *in
	if in.Affinity != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BlockCSIComponent.
func (in *BlockCSIComponent) DeepCopy() *BlockCSIComponent {
	if in == nil {
		return nil
	}
	out := new(BlockCSIComponent)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IBMBlockCSIControllerSpec) DeepCopyInto(out *IBMBlockCSIControllerSpec) {
	*out = *in
	in.BlockCSIComponent.DeepCopyInto(&out.BlockCSIComponent)
	return
}
