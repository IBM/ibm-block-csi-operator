...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"./pkg/apis/csi/v1.Config":                    schema_pkg_apis_csi_v1_Config(ref),
		"./pkg/apis/csi/v1.ConfigSpec":                schema_pkg_apis_csi_v1_ConfigSpec(ref),
		"./pkg/apis/csi/v1.ConfigStatus":              schema_pkg_apis_csi_v1_ConfigStatus(ref),
		"./pkg/apis/csi/v1.IBMBlockCSI":               schema_pkg_apis_csi_v1_IBMBlockCSI(ref),
		"./pkg/apis/csi/v1.IBMBlockCSIControllerSpec": schema_pkg_apis_csi_v1_IBMBlockCSIControllerSpec(ref),
		"./pkg/apis/csi/v1.IBMBlockCSINodeSpec":       schema_pkg_apis_csi_v1_IBMBlockCSINodeSpec(ref),
		"./pkg/apis/csi/v1.IBMBlockCSISpec":           schema_pkg_apis_csi_v1_IBMBlockCSISpec(ref),
		"./pkg/apis/csi/v1.IBMBlockCSIStatus":         schema_pkg_apis_csi_v1_IBMBlockCSIStatus(ref),
		"./pkg/apis/csi/v1.NodeAgentSpec":             schema_pkg_apis_csi_v1_NodeAgentSpec(ref),
		"./pkg/apis/csi/v1.NodeAgentStatus":           schema_pkg_apis_csi_v1_NodeAgentStatus(ref),
		"./pkg/apis/csi/v1.NodeInfo":                  schema_pkg_apis_csi_v1_NodeInfo(ref),
		"./pkg/apis/csi/v1.NodeInfoSpec":              schema_pkg_apis_csi_v1_NodeInfoSpec(ref),
		"./pkg/apis/csi/v1.NodeInfoStatus":            schema_pkg_apis_csi_v1_NodeInfoStatus(ref),
	}
}
...
func schema_pkg_apis_csi_v1_Config(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.ConfigSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.ConfigStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/csi/v1.ConfigSpec", "./pkg/apis/csi/v1.ConfigStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"nodeAgent": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.NodeAgentSpec"),
						},
					},
				},
...
func schema_pkg_apis_csi_v1_ConfigStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"nodeAgent": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./pkg/apis/csi/v1.NodeAgentStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"./pkg/apis/csi/v1.NodeAgentStatus"},
	}
}
...
func schema_pkg_apis_csi_v1_IBMBlockCSI(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.IBMBlockCSISpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.IBMBlockCSIStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/csi/v1.IBMBlockCSISpec", "./pkg/apis/csi/v1.IBMBlockCSIStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_csi_v1_IBMBlockCSISpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"controller": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.IBMBlockCSIControllerSpec"),
						},
					},
					"node": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.IBMBlockCSINodeSpec"),
						},
					},
					"sidecars": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("./pkg/apis/csi/v1.CSISidecar"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"./pkg/apis/csi/v1.CSISidecar", "./pkg/apis/csi/v1.IBMBlockCSIControllerSpec", "./pkg/apis/csi/v1.IBMBlockCSINodeSpec"},
	}
}
...
func schema_pkg_apis_csi_v1_NodeInfo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.NodeInfoSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/csi/v1.NodeInfoStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/csi/v1.NodeInfoSpec", "./pkg/apis/csi/v1.NodeInfoStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
